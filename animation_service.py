...
_QWEN_PROMPT = """你是论文图分析专家。请判断这张图片是否包含**流程图/架构图/机制图**。
...
【识别到图形时，返回】
{
  ...
  "nodes": [
    {"id": "n1", "label": "节点原文（英文或数字，如 N=78 或 Encoder）", "label_zh": "中文含义", "type": "process|module|data|input|output|molecule|protein|cell|organ|drug", "x": 0.35, "y": 0.25}
  ],
...
def process_image(image_bytes: bytes, abstract: str = "") -> dict:
    """
